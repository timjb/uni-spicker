...
\begin{sprech}
  ...
  \begin{center}
    \begin{tabular}{r l l}
      $\Wat$ & $\xrightarrow{{\sim}}$ & \emph{schwache Äquivalenz} \\
      $\Cat$ & $\xhookrightarrow{\phantom{{\sim}}}$ & \emph{Kofaserung} \\
      $\Cat \cap \Wat$ & $\xhookrightarrow{{\sim}}$ & \emph{azyklische Kofaserung} \\
      $\Fat$ & $\xtwoheadrightarrow{\phantom{{\sim}}}$ & \emph{Faserung} \\
      $\Fat \cap \Wat$ & $\xtwoheadrightarrow{{\sim}}$ & \emph{azyklische Faserung}
    \end{tabular}
  \end{center}
\end{sprech}

\begin{bem}
  Ist $(\Wat, \Cat, \Fat)$ eine Modellstruktur auf $\MatC$, so ist $(\Wat^\op, \Fat^\op, \Cat^\op)$ eine Modellstruktur auf $\MatC^\op$.
\end{bem}
