...
\begin{defn}
  Eine Kategorie heißt genau dann \emph{$\kappa$-filtriert}, wobei $\kappa$ eine reguläre Kardinalzahl ist, wenn jedes $\kappa$-kleine Diagramm in der Kategorie einen Kokegel besitzt.
\end{defn}
