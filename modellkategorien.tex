...
\begin{defn}
  Eine \emph{kombinatorische Modellkategorie} ist eine lokal präsentierte Modellkat. $\ModC$ mit Modellstr. \ModStr{}, sodass Mengen $\Iat, \Jat \subset \Mor(\ModC)$ existieren, sodass $\Cof = \Coff(\Iat)$ und $\Cof \cap \Weak = \Coff(\Jat)$.
\end{defn}
