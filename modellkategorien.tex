...
\begin{beob}
  Sei $X \amalg X \xrightarrow{i} C \xrightarrow{p \enspace ~} X$ irgendein Zylinderobjekt.
  Faktorisiere $i = q \circ i'$ in Kofaserung und azyklische Faserung. Dann ist auch
  \[ X \amalg X \xhookrightarrow{i'} X' \xrightarrow{pq \enspace ~} X \]
...
\begin{bspe}
  \begin{itemize}
    ...
    %\item $\SetC$ ist lokal $\aleph_0$-präsentierbar mit $S = \{ \heart \}$.
