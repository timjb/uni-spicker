...
\begin{defn}
  Ist $A \subset X$ konvex, so heißt $f : A \to \R \cup \{ \pm\infty \}$ \emph{konvexe Funktion}, falls für alle $x, y \in A$ und $t \in \cinterval{0}{1}$ gilt:
