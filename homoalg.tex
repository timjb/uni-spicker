...
\begin{bem}
  Der \emph{Garbifizierungsfunktor} $s : \PShAb(X) \to \ShAb(X)$ ist def. auf Prägarben abelscher Gruppen $\Fais$ und $U \subset X$ offen durch
  \iffalse
  \begin{align*}
  ...
  \fi
  \begin{align*}
    s(\Fais)(U) \coloneqq \{ \, & \text{Paare $(U_i, s_i)_{i \in I}$, wobei $U = {\bigcup}_{i \in I} U_i$ und $U_i \subset U$ offen} \\
     & \text{ist und $(s_i \!\in\! \Fais(U_i))_{i \in I}$ lokal kompatibel sind, \dh{}} \\
     & \fa{i, j\!}\! \fa{x \!\in\! U_i \!\cap\! U_j\!}\! \ex{V \!\subset\! U_i \!\cap\! U_j \text{ offen}} s_i|_V \!=\! s_j|_V \, \} / {\sim}
  \end{align*}\vspace{-16pt}
  \begin{align*}
...
\begin{prop}
  ...
  \[ \ShAb(X) \to \AbGrp, \enspace \Fais \mapsto \Gamma(U, \Fais) \]
  ist links-exakt.
\end{prop}
