...
% TODO:
% * Abschnitt über (Ko-) Homologie verallgemeinern, hinter dem Abschnitt über abelsche Kategorien stellen (?)
% * Diagrammjadgregeln
% * Propositionen über welke/weiche/feine Garben von ÜB 6
...
% TODO: Verschieben in Garbenabschnitt?
% II.6.15
\begin{defn}
...
% III.1.1
\begin{defn}
  Eine \emph{projektive Auflösung} eines Objektes $E \in \Ob(\Aat)$ ist ein Kettenkomplex $\CC{F}$ bestehend aus projektiven Objekten in $E$ und ein Augmentierungsmorphismus $\epsilon : F_0 \to E$, sodass
