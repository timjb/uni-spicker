...
\begin{defn}
  ...
  \begin{align*}
    s(\Fais)(U) \coloneqq \{ \, & \text{Familien $(s_i \in \Fais(U_i))_{i \in I}$ von lokal kompatiblen} \\
...
\begin{bem}
  \begin{itemize}
    \item Die Konstruktion funkt. für (Prä-)Garben von Mengen, ab. Gruppen, $A$-Linksmoduln und auch für $\O_X$-Modulgarben, wenn $f : (X, \O_X) \!\to\! (Y, \O_Y)$ ein Morphismus von geringten Räumen ist.
