...
% II.5.13
\begin{thm}
  Der Inklusionsfunktor $i : \Sh(X) \to \PSh(X)$ besitzt einen Linksadjungierten $s : \PSh(X) \to \Sh(X)$. Für jede Garbe $\Fais$ gilt $si \Fais \cong \Fais$.
\end{thm}
...
% TODO: Schlangenlemma, Fünferlemma
