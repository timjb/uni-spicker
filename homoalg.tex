...
\begin{defn}
  Man sagt, eine ab. Kat. besitze \emph{genug projektive Objekte}, wenn jedes Objekt Quotient eines projektiven Objektes ist. \\
  Man sagt, sie besitze \emph{genug injektive Objekte}, falls jedes Objekt ein Unterobjekt eines injektiven Objektes ist.
\end{defn}
...
\begin{defn}
  ...
  \begin{align*}
    \Ob(\Aat[T]) & \coloneqq \{\, \text{Paare $(X, t)$ mit $X \in \Ob(\Aat)$ und $t \in \End_\Aat(X)$.} \,\}, \\
...
% TODO: III.5.20 (Die abgeleitete Kategorie und injektive Auflösungen)
