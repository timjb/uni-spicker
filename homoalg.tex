...
\begin{thm}
  Seien $\Aat$, $\Bat$ und $\Cat$ ab. Kategorien, $F : \Aat \to \Bat$ und $G : \Bat \to \Cat$ linksexakte Funktoren.
  Sei $\Ada_\Aat \!\subset\! \Ob(\Aat)$ an $F$ und $\Ada_\Bat \!\subset\! \Ob(\Bat)$ an $G$ angepasst.
  Angenommen, $F(\Ada_\Aat) \subseteq \Ada_\Bat$.
  Dann existieren $RF$, $RG$ und $R(G \circ F)$ und die von der univ. Eigenschaft induzierte natürliche Transformation $R(G \circ F) \to RG \circ RF$ ist ein Isomorphismus.
\end{thm}
...
% III.7.3
\begin{bem}
  Es gibt eine separate \spickerref{spektralsequenzen}{Zusammenfassung zu Spektralsequenzen}.
\end{bem}

% TODO: II.7.5. Spektralsequenz eines Doppelkomplexes
