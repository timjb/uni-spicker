...
% III.1.4a)
\begin{kor}
  Seien $\CC{P} \to X$ und $\CC{P} \to X$ projektive Auflösungen desselben Obj. $X \in \Ob(\Aat)$. Dann gibt es einen Morphismen von Auflösungen $f : \CC{P} \to \CC{Q}$ und $g : \CC{Q} \to \CC{P}$ mit $f \circ g \simeq \id$ und $g \circ f \simeq \id$.
\end{kor}
