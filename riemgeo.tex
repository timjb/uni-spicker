...
\begin{defn}
  Der \emph{Kommutator} (o. \emph{Lie-Klammer}) von $X, Y \in \VF(M)$ ist das Vektorfeld $[X, Y] \in \VF(M)$, das definiert ist durch
  \[
...
\begin{defn}
  Sei $f : M \to N$ ein Diffeomor. und $X \in \VF(M)$. Dann ist
  \[
    f_* X : N \to TN, \enspace
