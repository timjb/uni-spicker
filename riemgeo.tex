...
\newcommand{\Exp}{\mathrm{Exp}} % Exponentialabbildung
...
\newcommand{\Iso}{\mathrm{Iso}} % Isometriegruppe
\newcommand{\Trans}{\mathrm{Trans}} % Transvektionsgruppe
...
\begin{satz}[\emph{1. Variationsformel} für stückweise glattes $c$]
