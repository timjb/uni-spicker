...
\begin{satz}
  Die Abbildung
  \[
    \I_{R_{ij}} : \chi(U) \times \chi(U) \to \mathcal{C}^\infty(U, \R), \qquad
...
\begin{defn}
  Eine Abbilung $f : O \to \widetilde{O}$ heißt \emph{kugeltreu}, wenn sie offene Teilmengen von Sphären auf offene Teilmengen von Sphären abbildet. Dabei gelten Hyperebenen als Sphären von unendlichem Radius.
\end{defn}
