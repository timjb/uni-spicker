...
\begin{satz}[\emph{Polarwinkelfunktion}]
  Sei $\gamma : [a, b] \to S^1$ stetig (glatt) und $\omega_a \in \R$, sodass $\gamma(a) = e^{i \omega_a}$. Dann gibt es eine eindeutige stetige (glatte) Abb. $\omega : [a, b] \to \R$, genannt Polarwinkelfunktion von $\gamma$ mit $\omega(a) = \omega_a$ und $\gamma(t) = e^{i \omega(t)} = \begin{psmallmatrix} \cos(\omega(t)) \\ \sin(\omega(t)) \end{psmallmatrix}$ für alle $t \in [a, b]$.
\end{satz}
...
\begin{defn}
  Für eine reg. geschlossene ebene Kurve $c : \left[ a, b \right] \to \R^2$ heißt
  \[
