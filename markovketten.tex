...
% 3.37
\begin{satz}[\emph{Optional Stopping Theorem}]
  Seien $S \leq T$ zwei Stoppzeiten.
  Falls $\{ M_{T \wedge n} \}$ ein gleichgradig integrierbares Submartingal ist, so gilt: $M_S \leq \E[ M_T | \Filt_S ]$
\end{satz}

% Kapitel 4: Rekurrenz und Transienz mithilfe von Sub- und Supermartingalen
\section{Rek. und Transienz mit Martingaltheorie}
