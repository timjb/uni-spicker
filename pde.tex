...
\begin{defn}
  %Sei $\Omega \subset \R^n$ offen. Eine Funktion $G : \Set{ (x, y) \in \Omega \times \Omega }{ x \not= y } \to \R$ heißt \emph{Greensche Funktion} für das Gebiet $\Omega$, falls für alle $x \in \Omega$ gilt:
