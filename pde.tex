...
\begin{kor}[Mittelwertseigenschaft]
  ...
  \]
  In diesen Gleichungen darf man alle $=$ durch $\leq$ oder $<$ ersetzen.
\end{kor}
...
% 2.4.
\begin{satz}
  Sei $\Omega \subset \R^n$ offen, beschränkt und $u \in \mathcal{C}^2(\Omega) \cap \mathcal{C}^0(\overline{\Omega})$ subharmonisch in $\Omega$. Dann gilt
  \begin{itemize}
...
% Ausgelassen: Bemerkung 2.33. in Skript "`Laplace"'
...
% Nachzutragen: Definition Glättungskern, Faltung, Eigenschaften der Glättung
