...
\begin{defn}
  Zwei stetige Abbildungen $f, g : X \to Y$ heißen \emph{homotop relativ zu} $A \subset X$ (geschrieben $f \simeq g \rel A$), falls es eine Homotopie $H : X \times \cinterval{0}{1} \to Y$ von $f$ nach $g$ gibt mit $Ha(t) = Ha,0)$ für alle $a \in A$ und $t \in \I$.
\end{defn}
