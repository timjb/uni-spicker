...
\begin{prop}
  Sei $p : X \to Y$ eine Überlagerung, $X$ wegzshgd und lokal wegzshgd und $G < \Deck(p)$ eine Untergruppe. Angenommen, für alle $y \in Y$ und $x_0, x_1 \in p^{-1}(y)$ existiert $g \in G$ mit $g(x_0) = x_1$. Dann gilt $G = \Deck(p)$.
\end{prop}
...
\begin{bspe}
  \begin{itemize}
    \item Simplizialkomplexe und Mftn sind semilokal einfach zshgd.
