...
\begin{lem}
  ...
  \begin{itemize}
    ...
    \miniitem{0.55 \linewidth}{$G$ ist hausdorffsch $\iff$ $H = \{ e \}$}
  \end{itemize}
\end{lem}
...
% 41.2. Reessche Ringe und Moduln
...
% 41.3. Das Artin-Reessche Lemma

\begin{lem}[\emph{Artin--Rees}]
  Sei~$A$ kommutativ, noethersch und $M$ endlich erzeugt.
...
\begin{kor}
  ...
  \begin{align*}
    ...
    \enspace \text{und} \enspace
    M' \supseteq (\aaa M) \cap M' \subseteq (\aaa^2 M) \cap M' \supseteq \ldots
  \end{align*}
...
\begin{prop}
  ...
  Ist zus.~$A$ noethersch, so ist die Abb. sogar ein Isomorphismus.
\end{prop}
...
\begin{prop}
  ...
  \begin{itemize}
    ...
    \item $\widehat{\aaa}_\aaa$ liegt im Jacobsonschen Radikal von~$\hat{A}_\aaa$, falls $\aaa \neq (1)$.
  \end{itemize}
\end{prop}
