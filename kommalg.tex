...
\begin{kor}
  In noetherschen kommutativen Ringen ist jedes Ideal zerlegbar.
\end{kor}

\begin{prop}
  Sei $A$ ein noetherscher kommutativer Ring.
  Dann enthält jedes Ideal $\aaa \subseteq A$ eine Potenz $(\sqrt{\aaa})^n$ seines Wurzelideals.
\end{prop}

\begin{kor}
  Sei $A$ ein noeth. komm. Ring.
  Dann ist $\sqrt{(0)} \subseteq A$ nilpotent.
\end{kor}

\begin{kor}
  Sei $A$ ein noeth. komm. Ring.
  Für ein maximales Ideal $\mmm \subset A$ und ein weiteres Ideal $\qqq \subseteq A$ sind äquivalent:
  \begin{itemize}
    \miniitem{0.44 \linewidth}{$\qqq$ ist ein $\mmm$-primäres Ideal.}
    \miniitem{0.17 \linewidth}{$\sqrt{\qqq} = \mmm$}
    \miniitem{0.35 \linewidth}{$\ex{n \in \N} \mmm^n \subseteq \qqq \subseteq \mmm$}
  \end{itemize}
\end{kor}

\begin{prop}
  Sei $A$ ein noeth. komm. Ring und $\aaa \subseteq A$ ein Ideal.
  Dann sind die zu $\aaa$ assoz. Ideale genau die Primideale von $A$ der Form $(\aaa : x)$ mit $x \in A$.
\end{prop}
...
\begin{prop}
  Jedes Primideal in einem artinschen kommutativen Ring ist ein maximales Ideal.
\end{prop}

\begin{kor}
  In einem artinschen komm. Ring ist das Nilradikal gleich dem Jacobsonschen Ideal.
\end{kor}

\begin{prop}
  Ein artinscher kommutativer Ring hat nur endlich viele maximale Ideale.
\end{prop}
