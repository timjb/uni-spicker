...
\begin{konstr}
  ...
  Trage $M$ die durch die Folge $M \supset \aaa M \supset \aaa^2 M \supset \ldots$ von Untermoduln definierte Topologie, die \textit{$\aaa$-adische Topologie}.
  Damit wird~$M$ zu einem~$A$, wenn~$A$ ebenfalls die $\aaa$-adische Topologie trägt.
\end{konstr}
