...
\begin{defn}
  Ein Netz $N$ heißt \emph{Free-Choice-Netz} (\textit{FC-Netz}), falls
  \[
    \fa{t, t' \in T} t \neq t' \wedge s \in \preset{t} \cap \preset{t'} \implies \preset{t} = \preset{t'} = \{ s \}.
  \]
  Ein Netz $N$ heißt \emph{erweit. Free-Choice-Netz} (\textit{EFC-Netz}), falls
  \[
    \fa{t, t' \in T} t \neq t' \wedge s \in \preset{t} \cap \preset{t'} \implies \preset{t} = \preset{t'}.
  \]
\end{defn}
...
% ausgelassen: Korollar 8.14: Sprach und F-Äquivalenz sind Kongruenzen bzgl. $\parallelComposition_A$
...
\TODO{Verstehen: Zusammenhang zum Testen}
