...
\newcommand{\MShSet}{(\mathbf{P})\mathbf{Sh}} % vielleicht Garbe, vielleicht Prägarbe von Mengen
\newcommand{\PShAb}{\mathbf{PAb}} % Prägarben von abelschen Gruppen
\newcommand{\ShAb}{\mathbf{Ab}} % Garben von abelschen Gruppen
\newcommand{\MShAb}{(\mathbf{P})\mathbf{Ab}} % vielleicht Garbe, vielleicht Prägarbe von abelschen Gruppen
