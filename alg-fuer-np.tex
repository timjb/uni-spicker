...
% https://stackoverflow.com/a/2019064
...
% 9.6
\begin{lem}
  Planare Graphen mit $n \geq 3$ Ecken haben $\leq 3 n - 6$ Kanten.
\end{lem}
...
% 9.10
\begin{lem}
  Jeder außenplanare Graph mit $n \geq 2$ Knoten hat $\leq 2 n - 3$ Kanten.
\end{lem}

% §9.2. Parameterized Independent Set
