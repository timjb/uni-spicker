...
\subsection{\scriptSection{4.3} Ein Approximationsalg.\ für das \Problem{TSP}}
...
\subsection{\scriptSection{6.2} \Problem{Minimum Bin Packing} mit dyn. Programmierung}
...
\begin{alg}[\emph{Randomized Rounding}] \mbox{} \\
  ...
  \begin{itemize}
    ...
    Bemerke: ${\sum}_{C \in \mathcal{C}} x_C \geq z^*$)
    \item
