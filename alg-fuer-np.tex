...
\begin{defn}
  ...
  Die in der $j$-ten Iteration gelöschten Knoten haben \textit{Außenplanaritätslevel~$j$}. \\
...
% 9.42
\begin{kor}
  Es gibt einen PTAS für Maximum Independent Set.
\end{kor}
...
\subsection{Minimum Steiner Forest}
...
\begin{alg}
  \begin{itemize}
    ...
    Wenn in einem Feuerbaum alle Knoten mit allen Knoten gleicher Farbe verbunden sind, so wird das Feuer inaktiv und setzt sich nicht mehr fort.
    \item
...
\begin{beweisidee}
  ...
  \[
    \begin{array}{r l}
      ...
      \leq & 2 \cdot \text{optimaler Wert des primalen LP (es gilt sogar $=$)} \\
...
\section{Grenzen der Approximierbarkeit}
