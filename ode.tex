...
\begin{bem}
  ...
  \begin{align*}
    ...
    \Rightarrow y_p(t) &= \left( \Int{t_0}{t}{b(\tau) \cdot \exp\left( - \Int{t_0}{\tau}{a(s)}{s} \right)}{\tau} \right) \cdot \exp\left( \Int{t_0}{\tau}{a(s)}{s} \right)
  \end{align*}
\end{bem}
...
\begin{kor}
  ...
  \[ y(t) = \left( y_0 + \Int{t_0}{t}{b(\tau) \cdot \exp\left( - \Int{t_0}{\tau}{a(s)}{s} \right)}{\tau} \right) \cdot \exp\left( \Int{t_0}{\tau}{a(s)}{s} \right) \]
\end{kor}
