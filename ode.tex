...
\begin{defn}
  ...
  \begin{itemize}
    \item \emph{stetig in $x \in \mathcal{D}$}, falls $T x_n \xrightarrow{n \to \infty} T x$ in $Y$ für jede Folge $(x_n)_{n \in \N}$ mit $x_n \xrightarrow{n \to \infty} x$ in $\mathcal{D}$ gilt.
