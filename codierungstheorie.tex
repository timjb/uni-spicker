...
\begin{bem}
  Insbesondere: \enspace
  \inlineitem{$t \geq 1 \implies \lambda_1 = \frac{\lambda {v-1 \choose t-1}}{{k-1 \choose t-1}}$} \quad
  \inlineitem{$\lambda_0 = b = \frac{\lambda {v \choose t}}{{k \choose t}}$}
