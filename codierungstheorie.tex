...
\begin{defn}
  Zwei lateinische Quadrate $A, B \in \Z_q^{q \times q}$ heißen \emph{orthogonal} ($A \perp B$), falls die Abbildung
  \[
...
\begin{satz}
  Es gibt keinen $6$-ären $(7, 6^5, 3)$-Code. (Solch ein Code wäre perfekt.)
\end{satz}
