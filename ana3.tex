...
\begin{satz}[Divergenzsatz]
  Sei $C \subset \R^n$ kompakt mit glattem Rand, $C^\circ \not= \emptyset$, $C = \overline{C^\circ}$, $G : \R^n \to \R^n$ ein $\mathcal{C}^1$-Vektorfeld, dann gilt:
...
Bekannt: $\d (G \cdot \d S) = \div (G) \d V$

\begin{satz}
  Sei $C \subset \widehat{U}$ kompakt mit $C = \overline{C^{\circ}} \not= \emptyset$, $\partial C$ glatt. Dann ist
  \[ \Intdf{C}{\div(G) \d V} = ... = \Intdf{\partial C}{G \cdot \d S} = \Int{\partial C}{}{\scp{G, \nu}}{\mathcal{A}}. \]
\end{satz}
