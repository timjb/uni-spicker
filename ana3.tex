...
\begin{satz}
  ...
  \begin{itemize}
    ...
    \begin{multicols}{2}
      ...
      \item $\forall \, a \in \R \,:\, \{ f \leq a \} \in \Alg$
    \end{multicols}
    \item $\forall \, a \in \R \,:\, \{ f < a \} \in \Alg$
  \end{itemize}
\end{satz}
...
\begin{nota}
  $x_j : U \to \R, \quad (u_1, ..., u_n) \mapsto u_j$ (Proj. auf $j$-te Koordinate)
\end{nota}
...
\begin{defn}
  Sei $U \opn \R^n$, $\widetilde{U} \opn \R^m$ und $\phi : \widetilde{U} \to U$ total diff'bar
  Der \emph{Rücktransport} (pullback) von $\omega$ unter $\phi$ ist eine $k$-Form auf $\widetilde{U}$ definiert durch
  \[ \phi^* \omega (\widetilde{u})) (X_1, ..., X_k) = (\omega (\phi(\widetilde{u})))((D_{\widetilde{u}} \phi) X_1, ..., D_{\widetilde{u}} \phi) X_1) \quad \text{für alle } \widetilde{u} \in \widetilde{U}, X_1, ..., X_k \in T_{\widetilde{u}} \widetilde{U} \]
\end{defn}
...
\begin{satz}
  ...
  Sei $\check{U} \opn \R^d$, $\widetilde{U} \opn \R^m$, $U \opn \R^n$ und $\psi : \check{U} \to \widetilde{U}$ und $\phi : \widetilde{U} \to U$ $\mathcal{C}^1$-Abbildungen.
  ...
  \begin{itemize}
    ...
    \item Wenn $\phi$ eine $\mathcal{C}^2$-Abb. ist, dann $\d (\varphi^* \omega) = \phi^* (\d \omega)$
    \item Wenn $\omega = \sum_{j_1 < ... < j_k} f_{j_1 \cdots f_k} \d x_{j_1} \wedge ... \wedge \d x_{j_k} : U \to \R$, dann gilt:
    \[ \phi^* \omega = \sum_{j_1 < ... < j_k} (f_{j_1 \cdots j_k} \cdot \phi) \d \phi_{j_1} \wedge ... \wedge \d \phi_{j_k} \]
  \end{itemize}
\end{satz}
